...
Feature: As an admin, I want the ability to click on the single arrow and select next and previous week on the calendar, so that I can view the schedule for the next and previous week.
  ...
  Scenario: TC_TMS586_02 Test that Admin could be able to click on the back arrow to the left of the calendar date range to view the previous week schedule.
    ...
    And Take a screenshot and saving it in "src/test/resources/Screenshots/Sprint_3/Admins/TMS_579/" as "TMS586_03"
  ...
  Scenario: TC_TMS586_02 Test that Admin could be able to click on the back arrow to the left of the calendar date range to view the previous week schedule.
    ...
    And Take a screenshot and saving it in "src/test/resources/Screenshots/Sprint_3/Admins/TMS_579/" as "TMS586_04"
