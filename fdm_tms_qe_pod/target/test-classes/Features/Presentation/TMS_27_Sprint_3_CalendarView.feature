Feature: TMS_27 Sort Filter on Start Date
  ...
  Scenario: TC_TMS205_03 Test that Admin can intially see  one weekly calendar
    ...
    And Take a screenshot and saving it in "src/test/resources/Screenshots/Presentation/TMS_27/" as "TMS_205_03"
  ...
  Scenario: TC_TMS205_04 Test that Admin can see the calendar that is aligned to current date.
    ...
    And Take a screenshot and saving it in "src/test/resources/Screenshots/Presentation/TMS_27/" as "TMS_205_04"
  ...
  Scenario: TC_TMS205_05 Test that Admin can see list of Trainers name in the first Column.
    ...
    And Take a screenshot and saving it in "src/test/resources/Screenshots/Presentation/TMS_27/" as "TMS_205_05"
  ...
  Scenario: TC_TMS205_06 Test that Calendar has AM and PM section for each day in the date.
    ...
    And Take a screenshot and saving it in "src/test/resources/Screenshots/Presentation/TMS_27/" as "TMS_205_06"
  ...
  Scenario: TC_TMS205_07 Test that Calendar has 1 week calendar button in the right top corner.
    ...
    And Take a screenshot and saving it in "src/test/resources/Screenshots/Presentation/TMS_27/" as "TMS_205_07"
