...
//	@FindBy(xpath = "//app-course-catalog-card//*[ text() ='Advanced Bash Scripting']//parent::div//parent::div//button")
//	private WebElement advancedBashScriptingCourseMaterials;
	...
	public void clickCourse( String courseName ) {
		...
		driver.findElement(By.xpath("//app-course-catalog-card//*[text() ='" + courseName + "']//parent::div//parent::div//button")).click();
	}
